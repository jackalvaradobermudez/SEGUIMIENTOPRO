    ...
    <header className="dashboard-header flex h-[88px] items-center justify-between px-9">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <span className="text-[16px] font-semibold leading-5 text-white">{userName}</span>
        ...
        <div className="hidden xl:flex items-center gap-2 ml-6 border-l border-white/10 pl-6">
          <Link
            href="/dashboard"
            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/[0.025] text-slate-300 hover:bg-white/[0.06] hover:text-white transition-all"
            title="Dashboard"
          >
          ...
          <Link
            ...
            className="relative flex h-10 w-10 items-center justify-center rounded-full border border-violet-500/20 bg-violet-500/10 text-violet-300 hover:bg-violet-500/20 hover:text-white transition-all"
            title="Cobros (Core)"
          >
            <CreditCard size={18} />
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={quickMenuRef}>
          ...
          {isQuickMenuOpen && (
            <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-xl border border-white/10 bg-[#091221]/95 p-1.5 shadow-2xl backdrop-blur-md z-50">
              <Link
                href="/dashboard/sales/new"
                onClick={() => setIsQuickMenuOpen(false)}
                className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-slate-300 hover:bg-white/[0.05] hover:text-white transition-colors"
              >
