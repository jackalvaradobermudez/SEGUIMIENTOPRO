...
export function StepClient({
  ...
  return (
    <div className="py-2">
      <h2 className="font-display text-xl font-bold text-[var(--text-primary)]">Paso 1 de 3: Tu primer cliente</h2>
      <p className="mt-1 text-sm text-slate-500">¿A quién le vendes? Agrega al menos uno.</p>
      ...
      <div className="mt-6 space-y-4">
        ...
        <div>
          <label className="mb-1.5 block text-sm font-medium text-[var(--text-primary)]">Teléfono (opcional)</label>
