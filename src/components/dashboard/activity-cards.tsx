  ...
  return (
    <div className="sp-card">
      <div className="sp-card-header flex flex-row items-center justify-between !pb-3">
        ...
        <button className="inline-flex h-9 items-center rounded-lg border border-white/10 bg-white/[0.03] px-4 text-sm font-medium text-white transition-colors hover:bg-white/[0.06] cursor-pointer">
          Ver todas
        </button>
      </div>
      <div className="sp-card-content flex flex-col !pt-2">
        <div className="flex items-center gap-4 border-b border-white/[0.06] py-3.5">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-white">Pago recibido de Ana María López</p>
        ...
        <div className="flex items-center gap-4 py-3.5">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-white">Venta creada para Carlos Ramírez</p>
            <p className="text-[13px] text-slate-400 mt-0.5">VTA-0004 · 30 Jun 2026</p>
          </div>
          <div className="text-right">
            <p className="text-sm font-semibold text-white tabular-nums">{formatAmount(85000)}</p>
    ...
    <div className="sp-card">
      ...
      <div className="sp-card-content flex flex-col !pt-2">
        {[
          ...
          <div key={item.ref} className={`flex items-center gap-4 py-3.5 ${index === 0 ? 'border-b border-white/[0.06]' : ''}`}>
            <div className="flex h-12 w-12 shrink-0 flex-col items-center justify-center rounded-lg border border-white/10 bg-white/[0.03]">
              <span className="text-lg font-bold leading-5 text-white tabular-nums">{item.day}</span>
