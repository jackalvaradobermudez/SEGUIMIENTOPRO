import { ArrowRight, CalendarDays, DollarSign, ShoppingCart } from 'lucide-react'
    ...
    <div className="rounded-3xl border border-white/10 bg-[#121B2B] p-6">
      <div className="mb-5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-violet-500/20 shadow-[0_0_20px_rgba(124,92,255,0.1)]">
            <ShoppingCart size={18} className="text-violet-300" />
          </div>
          <h3 className="text-sm font-medium text-slate-300">Actividad reciente</h3>
        </div>
        <button className="flex items-center gap-1 text-[13px] text-slate-400 transition-colors hover:text-white">
...
export function UpcomingPaymentsCard() {
  return (
    <div className="rounded-3xl border border-white/10 bg-[#121B2B] p-6">
      <div className="mb-5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-cyan-500/20 shadow-[0_0_20px_rgba(38,198,255,0.1)]">
            <CalendarDays size={18} className="text-cyan-300" />
          </div>
          <h3 className="text-sm font-medium text-slate-300">Próximos cobros</h3>
        </div>
        <button className="flex items-center gap-1 text-[13px] text-slate-400 transition-colors hover:text-white">
      ...
      <div className="flex flex-col gap-4">
        {[
          ...
          <div key={item.ref} className="flex items-center gap-4">
            <div className="flex h-12 w-12 shrink-0 flex-col items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03]">
